<?php
	...
	$Timestamp1 = htmlspecialchars($_GET["Sec"]);
	$ID2 = htmlspecialchars($_POST["ID"]);
	$Timestamp2 = htmlspecialchars($_POST["Sec"]);
	...
	$TableName = 'record';
	$sql="UPDATE $TableName SET call_duration_time='$Timestamp' WHERE ID='$ID'";
	//echo $sql;
  ...
  list($endtime, $sec) = explode(" ", microtime());
	...
	$jsondata['message'] = "Successful update Talking Duration=$Timestamp into Database";
