...
class CVoiceRecorderDlg : public CDialogEx
{
	DECLARE_DYNAMIC(CVoiceRecorderDlg)

public:
	CVoiceRecorderDlg(CWnd* pParent = nullptr);   // 標準建構函式
	virtual ~CVoiceRecorderDlg();

// 對話方塊資料
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_CVoiceRecorderDlg };
#endif
